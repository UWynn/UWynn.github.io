...
---
## Powders
Elemental powders have two major uses - they can be added to weapons or armor with sufficient slots to boost elemental damages or defenses, or used as crafting ingredients to give similar effects to crafted weapons and armor.
...
You can see the effects of armor powder specials on a build by manually adjusting the elemental damages.
