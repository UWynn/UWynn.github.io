...
|------------------|--------------------------------------------------------------|-----------------------------------------------------------------|---------------------------------------------------------------|-----------------------------------------------------------------|----------------------------------------------------------------|
| Quake            | Radius: 5 blocks <br />Damage: 155% ✤                               | Radius: 5.5 blocks <br />Damage: 220% ✤                                | Radius: 6 blocks <br />Damage: 285% ✤                                | Radius: 6.5 blocks <br />Damage: 350% ✤                                | Radius: 7 blocks <br />Damage: 415% ✤                                 |
...
These two are the most popular off-element weapon specials- it’s often better to sacrifice weapon damage numbers for the significant buff that comes with them. They even stack! However, since they’re a poison and spell/melee% boost, they don't affect raw melee. 
...
- Sorcery can recast both powder specials and melee attacks, which means absurd amounts of powder specialing on super slow attack speed. 
